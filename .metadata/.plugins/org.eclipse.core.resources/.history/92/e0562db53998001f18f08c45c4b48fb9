...
<body>
		...
		<div class="prdList_menu_wrap layout-view">
			<div data-ivcate-type="currentView_list_under"
				...
				<div class="cate_path">
					<ul>
						<li data-path="44">
							<a href="/product/list.html?cate_no=44">전체상품</a>
						</li>
						<li data-path="160"><a href="/product/list.html?cate_no=160">네일</a>
						</li>
						<li data-path="120"><a href="/product/list.html?cate_no=120">베스트</a>
						</li>
						<li data-path="121"><a href="/product/list.html?cate_no=121">신상품</a>
						</li>

						<!-- 아래 3개는 li 태그 속성 class="on" 들어가고 기존 위 li 태그에는 display:none -->
						<li data-path="161"><a href="/product/list.html?cate_no=161">페디</a>
						</li>
						<li data-path="160"><a href="/product/list.html?cate_no=160">네일</a>
						</li>
						<li data-path="49"><a href="/product/list.html?cate_no=49">케어
								&amp; 툴</a></li>
					</ul>
				</div>
				...
				<div class="cate_list">
					<ul class="menu_1ul">
						<li class="menu_1li" data-cate="44" data-depth="1"><a
							href="/product/list.html?cate_no=44">전체상품</a></li>
						<li class="menu_1li" data-cate="120" data-depth="1"><a
							href="/product/list.html?cate_no=120">베스트</a></li>
						<li class="menu_1li" data-cate="121" data-depth="1"><a
							href="/product/list.html?cate_no=121">신상품</a></li>
						<li class="menu_1li" data-cate="204" data-depth="1"><a
							href="/product/list.html?cate_no=204">pedi</a></li>
						<li class="menu_1li" data-cate="600" data-depth="1"><a
							href="/product/list.html?cate_no=600">gelstrip</a></li>
						<li class="menu_1li" data-cate="605" data-depth="1"><a
							href="/product/list.html?cate_no=605">gelnailtip</a></li>
						<li class="menu_1li" data-cate="671" data-depth="1"><a
							href="/product/list.html?cate_no=671">outlet</a></li>
						<li class="menu_1li" data-cate="751" data-depth="1"><a
							href="/product/list.html?cate_no=751">Best of Best</a></li>
						<li class="menu_1li" data-cate="752" data-depth="1"><a
							href="/product/list.html?cate_no=752">취향 따라 골라쓰는 네일&amp;페디</a></li>
					</ul>
					
					<ul class="menu_2ul">
						<li class="menu_2li" data-cate="${param.cate_no}" data-depth="2"><a
							href="/product/list.html?cate_no=${param.cate_no}">ALL</a></li>
						<li class="menu_2li" data-cate="160" data-depth="2"><a
							href="/product/list.html?cate_no=160">네일</a></li>
						<li class="menu_2li" data-cate="161" data-depth="2"><a
							href="/product/list.html?cate_no=161">페디</a></li>
						<li class="menu_2li" data-cate="49" data-depth="2"><a
							href="/product/list.html?cate_no=49">케어 &amp; 툴</a></li>
						
						<li class="menu_2li" data-cate="125" data-depth="2"><a
							href="/product/list.html?cate_no=125">네일</a></li>
						<li class="menu_2li" data-cate="127" data-depth="2"><a
							href="/product/list.html?cate_no=127">페디</a></li>
						<li class="menu_2li" data-cate="432" data-depth="2"><a
							href="/product/list.html?cate_no=432">젤네일팁</a></li>
						<li class="menu_2li" data-cate="431" data-depth="2"><a
							href="/product/list.html?cate_no=431">젤스트립</a></li>
						<li class="menu_2li" data-cate="540" data-depth="2"><a
							href="/product/list.html?cate_no=540">케어 &amp; 툴</a></li>
					</ul>

					<ul class="menu_3ul">
						<li class="menu_3li" data-cate="160" data-depth="3"><a
							href="/product/list.html?cate_no=160">ALL</a></li>
						<li class="menu_3li" data-cate="436" data-depth="3"><a
							href="/product/list.html?cate_no=436">젤네일팁</a></li>
						<li class="menu_3li" data-cate="435" data-depth="3"><a
							href="/product/list.html?cate_no=435">젤스트립</a></li>
					</ul>
				</div>
			</div>
		</div>
	...
	<script>
		// cate_no 값 가져오기
		const cateNo = ${param.cate_no};  // 서버에서 cate_no를 받아오는 방식에 따라 수정 필요
	
		// 넘어온 파라미터 값과 data-path 값이 다른 li 태그는 모두 제거
	    const catePath = document.querySelectorAll('.cate_path ul li');

	    catePath.forEach(item => {
	        if (item.getAttribute('data-path') != cateNo.toString()) {
	            item.remove();
	        }
	    });
	    ...
	    if (cateNo === 121 && menu_2ul) {
	        menu_2ul.remove();
	    } else {
	        menu_2ul.querySelectorAll('li').forEach(item => {
	            if (item.getAttribute('data-cate') == cateNo.toString()) {
	                item.classList.add('menu_virtual', 'submenu'); 
	            }
	        });
	    }
	    ...
	    if ((cateNo === 121 || cateNo === 120 || cateNo === 44) && menu_3ul) {
	        menu_3ul.remove();
	    } else {
		...
		<div id="second-wrap-layout">
			...
			<div id="item-list-wrap">
				...
				<div id="page-container">
					<a href="${ pvo.first }" class="first">first</a>

					<c:if test="${ pvo.prev == true }">
						<a href="${ pvo.start - 1 }" class="prev">prev</a>
					</c:if>
					...
					<ol>
						<c:forEach begin="${ pvo.start }" end="${ pvo.end }" step="1"
							...
							<c:choose>
								...
								<c:otherwise>
									<li><a
										href="/projectOhora/product/list.do?cate_no=${param.cate_no}&currentPage=${i}">${ i }</a></li>
								</c:otherwise>
							</c:choose>
						</c:forEach>
					</ol>
					<c:if test="${ pvo.next }">
						<a href="${ pvo.end + 1 }" class="next">next</a>
					</c:if>
					<a href="${ pvo.last }" class="last">last</a>
				</div>
